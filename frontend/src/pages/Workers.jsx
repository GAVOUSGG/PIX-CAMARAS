  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight">Trabajadores</h2>
          <p className="text-gray-400 text-sm mt-1">
            <span className="text-emerald-400 font-bold">{filteredWorkers.length}</span> de {workersData.length} trabajadores registrados
          </p>
        </div>
