    ...
    <div className="space-y-8 transform-gpu">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in">
        ...
        {activeTab === 'tournaments' && (
          <>
            <div className="md:col-span-2 bg-gradient-to-br from-slate-900/90 to-[#0B1120] border border-white/5 shadow-2xl rounded-[2rem] p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="bg-gradient-to-br from-slate-900/90 to-[#0B1120] border border-white/5 shadow-2xl rounded-[2rem] p-6 md:p-8 relative overflow-hidden group">
